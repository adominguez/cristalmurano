  ...
  theme: {
    extend: {
      colors: {
        ...colors,
        primary: {
            100: lighten('#4dd0e1', 0.4),
            200: lighten('#4dd0e1', 0.3),
            300: lighten('#4dd0e1', 0.2),
            400: lighten('#4dd0e1', 0.1),
            500: '#4dd0e1',
            600: darken('#4dd0e1', 0.1),
            700: darken('#4dd0e1', 0.2),
            800: darken('#4dd0e1', 0.3),
            900: darken('#4dd0e1', 0.4),
        },
        secondary: {
